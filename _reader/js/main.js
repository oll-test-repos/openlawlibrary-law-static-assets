...
/* harmony import */ var Shared_js_utils_HtmlUtils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! Shared/js/utils/HtmlUtils */ "../../../../../core__front-end/v2/shared/js/utils/HtmlUtils.js");
...
var addReaderLiteScripts = function addReaderLiteScripts() {
  ...
  if (documentCss === null) {
    ...
    try {
      var resourcePaths = (0,Shared_js_utils_HtmlUtils__WEBPACK_IMPORTED_MODULE_8__.findThemeDir)(documentCss); // Add Reader lite to the head of the HTML document

      (0,Shared_js_utils_HtmlUtils__WEBPACK_IMPORTED_MODULE_8__.addJS)({
...
/* harmony import */ var D_webnode_open_law_library_platform_publish_client_node_modules_babel_runtime_helpers_esm_taggedTemplateLiteral_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../node_modules/@babel/runtime/helpers/esm/taggedTemplateLiteral.js */ "../../../../../node_modules/@babel/runtime/helpers/esm/taggedTemplateLiteral.js");
...
/* harmony import */ var platform__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! platform */ "../../../../../node_modules/platform/platform.js");
/* harmony import */ var platform__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(platform__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _isFalsy__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./isFalsy */ "../../../../../core__front-end/v2/shared/js/utils/isFalsy.js");
/* harmony import */ var _isFalsy__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_isFalsy__WEBPACK_IMPORTED_MODULE_14__);
...
var AddHtmlClasses = function AddHtmlClasses() {
  ...
  var browserName = acceptableClassName((platform__WEBPACK_IMPORTED_MODULE_13___default().name));
  var browserEngine = acceptableClassName((platform__WEBPACK_IMPORTED_MODULE_13___default().layout));
...
var hasFileExtension = function hasFileExtension(url) {
  ...
  if (_isFalsy__WEBPACK_IMPORTED_MODULE_14___default()(extension) || extension.length < 2) {
    throw new Error("Please add a proper file extension. Got ".concat(extension));
  }

  var urlPattern = new RegExp(String.raw(_templateObject || (_templateObject = (0,D_webnode_open_law_library_platform_publish_client_node_modules_babel_runtime_helpers_esm_taggedTemplateLiteral_js__WEBPACK_IMPORTED_MODULE_1__["default"])([".", "((#|?){0,1}[a-zA-Z0-9.=#_-]{0,})$"], ["\\.", "((#|\\?){0,1}[a-zA-Z0-9.=#_-]{0,})$"])), extension), 'gmiu');
...
var addJS = function addJS(parameters) {
  ...
  if (_isFalsy__WEBPACK_IMPORTED_MODULE_14___default()(OPTIONS.src) && _isFalsy__WEBPACK_IMPORTED_MODULE_14___default()(OPTIONS.script)) {
...
var addCSS = function addCSS(parameters) {
  ...
  if (!_isFalsy__WEBPACK_IMPORTED_MODULE_14___default()(OPTIONS.media)) {
